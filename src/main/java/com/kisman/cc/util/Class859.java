...
import com.kisman.cc.util.Class2122;
...
extends Class2027 {
    ...
    public final Class2027 Method3637() {
        ...
        return new Class2027(n, n2, n3, ((Number)t4).intValue());
    }
    ...
    public Class859(@NotNull @NotNull Supplier supplier, @NotNull @NotNull Supplier supplier2, @NotNull @NotNull Supplier supplier3, @NotNull @NotNull Supplier supplier4) {
    ...
    public Class859(@NotNull @NotNull Supplier supplier, @NotNull @NotNull Supplier supplier2, @NotNull @NotNull Supplier supplier3) {
        Intrinsics.checkParameterIsNotNull((Object)supplier, (String)"red");
        Intrinsics.checkParameterIsNotNull((Object)supplier2, (String)"green");
        Intrinsics.checkParameterIsNotNull((Object)supplier3, (String)"blue");
        this(supplier, supplier2, supplier3, Class2122.Field17657);
    }
    ...
    private static String Method3642(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 213;
            cArray2[n] = (char)(cArray[n] ^ (0x327E ^ n2));
            ++n;
        }
