...
extends Class1740 {
    ...
    private TextComponentTranslation Method3519(Class42 class42) {
    ...
    public void Method1881(ITextComponent iTextComponent) {
        this.Method1874(new TextComponentTranslation(Class823.Method3517(), new Object[0]).appendSibling(iTextComponent));
    }
    ...
    public void Method1884(ITextComponent iTextComponent, Class42 class42) {
        this.Method1874(new TextComponentTranslation(Class823.Method3517(), new Object[0]).appendSibling((ITextComponent)this.Method3519(class42)).appendSibling(iTextComponent));
    }

    @Override
    public void Method1885(ITextComponent iTextComponent) {
        this.Method1874(new TextComponentTranslation(Class823.Method3517(), new Object[0]).appendSibling((ITextComponent)this.Method3518()).appendSibling(iTextComponent));
    }
    ...
    public void Method1891(ITextComponent iTextComponent) {
        this.Method1874(new TextComponentTranslation(Class823.Method3517(), new Object[0]).appendSibling((ITextComponent)this.Method3520()).appendSibling(iTextComponent));
    }
    ...
    private static String Method1893(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 70;
            cArray2[n] = (char)(cArray[n] ^ (0x5434 ^ n2));
            ++n;
        }
