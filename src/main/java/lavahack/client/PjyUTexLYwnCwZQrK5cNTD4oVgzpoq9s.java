...
public final class PjyUTexLYwnCwZQrK5cNTD4oVgzpoq9s
extends Hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF {
    @Nullable
    ...
    public PjyUTexLYwnCwZQrK5cNTD4oVgzpoq9s(@Nullable @Nullable String string, @NotNull @NotNull String string2, int n) {
    ...
    public PjyUTexLYwnCwZQrK5cNTD4oVgzpoq9s(@Nullable @Nullable String string, @NotNull @NotNull Hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF, int n) {
        Intrinsics.checkParameterIsNotNull((Object)hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF, (String)"uniform");
        this(string, hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF.Method3414(), n);
        this.Method3412(hbz9o7cw3UHbaO4ZnEUfDRM6OJGZSWeF.Method3413());
    }
    ...
    private static String Method3415(String string) {
        ...
        int n = (int)((long)-392385278 ^ (long)-392385278);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)-639190018L ^ 0xD9E6BB01);
            int n2 = (int)((long)-1988274284 ^ (long)-1988274299) << 3;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)540197197 ^ (long)540198128) << 4 ^ n2));
            ++n;
        }
