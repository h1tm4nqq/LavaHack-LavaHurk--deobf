...
public final class Class767 {
    ...
    public static final long Method3170(int n, int n2, int n3) {
        return ((long)n & Class767.Method3167()) << Class767.Method3166() | ((long)n2 & Class767.Method3168()) << Class767.Method3165() | (long)n3 & Class767.Method3169();
    }

    static {
        Field11250 = Field11249 = 1 + MathHelper.log2((int)MathHelper.smallestEncompassingPowerOfTwo((int)30000000));
        Field11251 = 64 - Field11249 - Field11250;
        Field11252 = 0 + Field11250;
