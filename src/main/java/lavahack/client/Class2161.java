...
extends Class1868 {
    ...
    public List Method942(@NotNull @NotNull EnumFacing enumFacing) {
        ...
        BlockPos blockPos2 = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing));
        ...
        BlockPos blockPos3 = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing)).offset(enumFacing);
        ...
        BlockPos blockPos4 = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing)).offset(enumFacing).up();
    ...
    private static String Method950(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 19;
            cArray2[n] = (char)(cArray[n] ^ (0x5A3A ^ n2));
            ++n;
        }
