...
final class Class2161 extends Class1868
{
    ...
    public List Method942(@NotNull @NotNull final EnumFacing enumFacing) {
        ...
        array[n] = offset;
        final int n2 = 1;
        final BlockPos offset2 = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing));
        Intrinsics.checkExpressionValueIsNotNull((Object)offset2, "BlockPos.ORIGIN.offset(f\u2026g).offset(facing.right())");
        array[n2] = offset2;
        final int n3 = 2;
        final BlockPos offset3 = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing)).offset(enumFacing);
        Intrinsics.checkExpressionValueIsNotNull((Object)offset3, "BlockPos.ORIGIN.offset(f\u2026g.right()).offset(facing)");
        array[n3] = offset3;
        final int n4 = 3;
        final BlockPos up = BlockPos.ORIGIN.offset(enumFacing).offset(Class184.Method1117(enumFacing)).offset(enumFacing).up();
        Intrinsics.checkExpressionValueIsNotNull((Object)up, "BlockPos.ORIGIN.offset(f\u2026ht()).offset(facing).up()");
        array[n4] = up;
        return CollectionsKt.listOf((Object[])array);
    }
    
    Class2161(final String s, final int n) {
    ...
    private static String Method950(final String s) {
        if (s != null) {
            ...
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x5A3A ^ 0x13));
            }
