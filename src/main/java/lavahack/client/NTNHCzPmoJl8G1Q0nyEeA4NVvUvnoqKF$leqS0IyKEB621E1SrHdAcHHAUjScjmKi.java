...
public final class NTNHCzPmoJl8G1Q0nyEeA4NVvUvnoqKF$leqS0IyKEB621E1SrHdAcHHAUjScjmKi
extends NTNHCzPmoJl8G1Q0nyEeA4NVvUvnoqKF {
    @NotNull
    ...
    public NTNHCzPmoJl8G1Q0nyEeA4NVvUvnoqKF$leqS0IyKEB621E1SrHdAcHHAUjScjmKi(@NotNull @NotNull int[] nArray) {
    ...
    private static String Method170(String string) {
        ...
        int n = (int)((long)2078214114 ^ (long)2078214114);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)561261914 ^ (long)561261989);
            int n2 = (int)((long)599493185 ^ (long)599493232) << 2;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-1844872917 ^ (long)-1844877760) ^ n2));
            ++n;
        }
