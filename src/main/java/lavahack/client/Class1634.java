...
implements Supplier {
    ...
    public final String Method6367() {
        ...
        Class44 class44 = this.Field15622.Method7101();
        Intrinsics.checkExpressionValueIsNotNull((Object)class44, (String)"stepVal");
        return stringBuilder.append(class44.Method335()).append(']').toString();
    }

    Class1634(Class1913 class1913) {
        this.Field15622 = class1913;
    }
    ...
    private static String Method6368(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 252;
            cArray2[n] = (char)(cArray[n] ^ (0x5893 ^ n2));
            ++n;
        }
