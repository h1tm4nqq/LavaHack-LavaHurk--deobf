...
public final class tdSm3RmMRb5Kp8aQNd26dKOJur9ncrg8$leqS0IyKEB621E1SrHdAcHHAUjScjmKi {
    ...
    @NotNull
    @NotNull
    public final tdSm3RmMRb5Kp8aQNd26dKOJur9ncrg8 Method6696(@NotNull @NotNull AxisAlignedBB axisAlignedBB) {
        Intrinsics.checkParameterIsNotNull((Object)axisAlignedBB, (String)"aabb");
        return new tdSm3RmMRb5Kp8aQNd26dKOJur9ncrg8(new Vec3d(axisAlignedBB.minX, axisAlignedBB.minY, axisAlignedBB.minZ), new Vec3d(axisAlignedBB.maxX - axisAlignedBB.minX, axisAlignedBB.maxY - axisAlignedBB.minY, axisAlignedBB.maxZ - axisAlignedBB.minZ));
    }

    private tdSm3RmMRb5Kp8aQNd26dKOJur9ncrg8$leqS0IyKEB621E1SrHdAcHHAUjScjmKi() {
    }

    public tdSm3RmMRb5Kp8aQNd26dKOJur9ncrg8$leqS0IyKEB621E1SrHdAcHHAUjScjmKi(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
    ...
    private static String Method6697(String string) {
        ...
        int n = (int)((long)748914113 ^ (long)748914113);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)-1694181803L ^ 0x9B04D6AA);
            int n2 = (int)((long)1395919396 ^ (long)1395919477) << 1;
            cArray2[n] = (char)(cArray[n] ^ ((int)24010953L ^ 0x16E4CAA ^ n2));
            ++n;
        }
