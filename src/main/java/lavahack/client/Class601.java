...
import lavahack.client.Class852;
...
public class Class601 {
    ...
    @NotNull
    @NotNull
    public final Class409 Method2599(@NotNull @NotNull PacketBuffer packetBuffer) {
        Intrinsics.checkParameterIsNotNull((Object)packetBuffer, (String)"buf");
    ...
    private static String Method2600(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 118;
            cArray2[n] = (char)(cArray[n] ^ (0xF8 ^ n2));
            ++n;
        }
