...
public class jYPQY2rjNdmpqScriHslP07wKHAmJu7j {
    ...
    public jYPQY2rjNdmpqScriHslP07wKHAmJu7j(Vec3i vec3i, Vec3i vec3i2, boolean bl) {
    ...
    public Queue Method6242() {
        return new jYPQY2rjNdmpqScriHslP07wKHAmJu7j$leqS0IyKEB621E1SrHdAcHHAUjScjmKi((Object[])this.Field15435, null);
    }
    ...
    public void Method6243() {
        ...
        int n = (int)-970806570L ^ 0xC622AAD6;
    ...
    public void Method6244() {
        this.Field15435 = new BlockPos[this.Field15434];
        int n = (int)-80201884L ^ 0xFB383764;
        int n2 = this.Field15425;
        while (n2 <= this.Field15428) {
            for (int i = this.Field15426; i <= this.Field15429; ++i) {
                for (int j = this.Field15427; j <= this.Field15430; ++n, ++j) {
