...
implements Class1471 {
    public static final Class333 Field9387 = new Class333();
    ...
    @Nullable
    @Nullable
    public final Void Method1661(@NotNull @NotNull Class424 class424) {
        Intrinsics.checkParameterIsNotNull((Object)class424, (String)"arg");
        Class135.Field8499.Method930().Method1726(class424.Method2054(0), false);
        Class135.Field8501.Method930().Method1726(class424.Method2054(0), false);
        return null;
    }
    ...
    private static String Method1662(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 127;
            cArray2[n] = (char)(cArray[n] ^ (0x4D34 ^ n2));
            ++n;
        }
