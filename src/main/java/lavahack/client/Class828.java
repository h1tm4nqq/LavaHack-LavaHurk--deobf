...
implements ToIntFunction {
    public static final Class828 Field11526 = new Class828();
    ...
    public final int Method3550(ItemStack itemStack) {
        ...
        return 100 - (1 - (itemStack2.getMaxDamage() - itemStack.itemDamage) / itemStack.getMaxDamage()) * 100;
    }
    ...
    private static String Method3551(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 134;
            cArray2[n] = (char)(cArray[n] ^ (0x2A4A ^ n2));
            ++n;
        }
