...
final class Class836
implements Class1471 {
    public static final Class836 Field11555 = new Class836();
    ...
    @Nullable
    @Nullable
    public final Void Method3560(@NotNull @NotNull Class424 class424) {
    ...
    private static String Method3561(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 91;
            cArray2[n] = (char)(cArray[n] ^ (0xEDE ^ n2));
            ++n;
        }
