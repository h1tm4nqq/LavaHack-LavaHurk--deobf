...
public final class VKNIwSUCQUw8Y8J9DVJeBWjGHMomWUXv
extends Entity {
    @NotNull
    ...
    public VKNIwSUCQUw8Y8J9DVJeBWjGHMomWUXv(@NotNull @NotNull World world, int n) {
    ...
    private static String a(String string) {
        ...
        int n = (int)-833795794L ^ 0xCE4D492E;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)926511642 ^ (long)926511845);
            int n2 = (int)1643744754L ^ 0x61F98DC3;
            cArray2[n] = (char)(cArray[n] ^ (((int)1782768735L ^ 0x6A42F6B2) << 2 ^ n2));
            ++n;
        }
