...
public final class hJ5MVoBCuC87iWFODIWqYtZSHT4lfVU7$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf {
    ...
    public hJ5MVoBCuC87iWFODIWqYtZSHT4lfVU7$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf(int n, @Nullable @Nullable String string, @NotNull @NotNull DimensionType dimensionType, @NotNull @NotNull Vec3d vec3d, @NotNull @NotNull ArrayList arrayList) {
    ...
    private static String Method2258(String string) {
        ...
        int n = (int)35192473L ^ 0x218FE99;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)-1388207647L ^ 0xAD41A11E);
            int n2 = ((int)807317829L ^ 0x301EB17E) << 1;
            cArray2[n] = (char)(cArray[n] ^ (((int)1453995327L ^ 0x56AA1426) << 1 ^ n2));
            ++n;
        }
