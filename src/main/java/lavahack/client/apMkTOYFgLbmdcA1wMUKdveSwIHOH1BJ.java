...
public final class apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ {
    ...
    public static final ICustomGoalProcess Method5982() {
        ICustomGoalProcess iCustomGoalProcess = apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5981().getCustomGoalProcess();
    ...
    public static final IPathingBehavior Method5983() {
        IPathingBehavior iPathingBehavior = apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5981().getPathingBehavior();
    ...
    public static final void Method5984(int n, int n2) {
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().setGoalAndPath((Goal)new GoalXZ(n, n2));
    }

    public static final void Method5985(int n, int n2, int n3) {
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().setGoalAndPath((Goal)new GoalBlock(new BlockPos(n, n2, n3)));
    }
    ...
    public static final void Method5986(@NotNull @NotNull BlockPos blockPos) {
        ...
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().setGoalAndPath((Goal)new GoalBlock(blockPos));
    }

    public static final void Method5987(int n) {
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().setGoalAndPath((Goal)new GoalYLevel(n));
    }

    public static final void Method5988(int n, int n2) {
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().setGoalAndPath((Goal)new GoalInverted((Goal)new GoalXZ(n, n2)));
    }

    public static final void Method5989() {
        apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5983().cancelEverything();
    }

    public static final boolean Method5990() {
        return apMkTOYFgLbmdcA1wMUKdveSwIHOH1BJ.Method5982().isActive();
    }
    ...
    private static String Method5991(String string) {
        ...
        int n = (int)1968092247L ^ 0x754EB457;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)-770778123L ^ 0xD20EDB0A);
            int n2 = (int)1284558286L ^ 0x4C90CD5F;
            cArray2[n] = (char)(cArray[n] ^ (((int)525986486L ^ 0x1F59DACB) << 1 ^ n2));
            ++n;
        }
