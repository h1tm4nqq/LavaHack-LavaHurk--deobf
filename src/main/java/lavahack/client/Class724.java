...
final class Class724
implements ToDoubleFunction {
    public static final Class724 Field11083 = new Class724();
    private int Field11084;

    public double applyAsDouble(Object object) {
        return this.Method3038((Class387)object);
    }

    public final double Method3038(Class387 class387) {
