...
public final class YKpXCFLm1fUIRSMvKJCMx60MfXpx5yro$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV
extends YKpXCFLm1fUIRSMvKJCMx60MfXpx5yro$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf {
    ...
    public YKpXCFLm1fUIRSMvKJCMx60MfXpx5yro$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV(@NotNull @NotNull String string, int n) {
    ...
    private static String Method5081(String string) {
        ...
        int n = (int)-288864099L ^ 0xEEC8489D;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)548361518L ^ 0x20AF55D1);
            int n2 = (int)-1851698856L ^ 0x91A15197;
            cArray2[n] = (char)(cArray[n] ^ ((int)110761163L ^ 0x69A5FA2 ^ n2));
            ++n;
        }
