...
public final class jD2gtZTnCH19EGvbKbXGsOxMql8GByzW {
    @NotNull
    ...
    public jD2gtZTnCH19EGvbKbXGsOxMql8GByzW(@NotNull @NotNull Entity entity, @NotNull @NotNull BlockPos blockPos, float f) {
    ...
    private static String Method1870(String string) {
        ...
        int n = (int)((long)-88631688 ^ (long)-88631688);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)1743065959L ^ 0x67E51398);
            int n2 = (int)((long)-2016067697 ^ (long)-2016067664) << 2;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-784300073 ^ (long)-784278898) ^ n2));
            ++n;
        }
