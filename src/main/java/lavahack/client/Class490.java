...
public final class Class490 extends Class2123
{
    private String Field10044 = " TheKisDevs & LavaHack Development owns you, and I am sorry, because it is uncrackable <3";
    
    public Class490(@NotNull @NotNull final Entity entity, final double n, final double n2, final double n3, final float n4, final float n5) {
        Intrinsics.checkParameterIsNotNull((Object)entity, "entity");
        super(entity, n, n2, n3, n4, n5, (DefaultConstructorMarker)null);
    }
    ...
    private static String Method170(final String s) {
        if (s != null) {
            ...
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x51F2 ^ 0x3D));
            }
