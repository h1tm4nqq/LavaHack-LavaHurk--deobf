...
public final class rxldtdwW9xUI3MOzQtLJzEiPFfPcvb89$2
implements CjzMEJvuBWIs0JH3fdtolwet3Z498EUb {
    ...
    public boolean Method5353(@NotNull @NotNull BlockPos blockPos) {
        ...
        return Intrinsics.areEqual((Object)iBlockState.getBlock(), (Object)Blocks.PORTAL);
    }

    @Override
    public boolean Method5352(Object object) {
        return this.Method5353((BlockPos)object);
    }

    rxldtdwW9xUI3MOzQtLJzEiPFfPcvb89$2() {
    }

    private static String Method5354(String string) {
        if (string == null) throw new NullPointerException("String deobfuscation parameter should not be null");
        char[] cArray = string.toCharArray();
        char[] cArray2 = new char[cArray.length];
        int n = (int)((long)-531751919 ^ (long)-531751919);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)1791399220 ^ (long)1791399371);
            int n2 = (int)((long)-93433701 ^ (long)-93433698) << 4;
            cArray2[n] = (char)(cArray[n] ^ (((int)-67410926L ^ 0xFBFB711B) << 1 ^ n2));
            ++n;
        }
