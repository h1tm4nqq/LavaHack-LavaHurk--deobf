...
final class Class325 implements Class1471
{
    public static final Class325 Field9365;
    ...
    public Object Method1564(final Class424 class424) {
        return this.Method1640(class424);
    }
    
    @Nullable
    @Nullable
    public final Void Method1640(@NotNull @NotNull final Class424 class424) {
    ...
    static {
        Field9365 = new Class325();
    }
    
    private static String Method1641(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x8F7 ^ 0x81));
            }
