...
implements Class1471 {
    public static final Class322 Field9362 = new Class322();
    ...
    @Nullable
    @Nullable
    public final Void Method1631(@NotNull @NotNull Class424 class424) {
    ...
    private static String Method1632(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 53;
            cArray2[n] = (char)(cArray[n] ^ (0x5DED ^ n2));
            ++n;
        }
