...
public class PWp1br303EYNjlFc7NtOEMllshuTpeq8 {
    private final GuiScreen Field11707;
    private int Field11708;
    private int Field11709;

    private PWp1br303EYNjlFc7NtOEMllshuTpeq8(GuiScreen guiScreen, int n) {
    ...
    public void Method3678(TickEvent.ClientTickEvent clientTickEvent) {
        this.Field11708 -= (int)((long)-967534687 ^ (long)-967534688);
    ...
    public static void Method3679(GuiScreen guiScreen, int n) {
        MinecraftForge.EVENT_BUS.register((Object)new PWp1br303EYNjlFc7NtOEMllshuTpeq8(guiScreen, n));
    }
}
