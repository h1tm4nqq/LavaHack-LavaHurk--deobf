...
import lavahack.client.wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV;
import lavahack.client.wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf;
import lavahack.client.wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$leqS0IyKEB621E1SrHdAcHHAUjScjmKi;
...
public final class wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz {
    @NotNull
    private final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV Field12213;
    @NotNull
    private final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$leqS0IyKEB621E1SrHdAcHHAUjScjmKi Field12214;
    @NotNull
    private final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf Field12215;
    @NotNull
    ...
    @NotNull
    @NotNull
    public final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV Method3997() {
        return this.Field12213;
    }

    @NotNull
    @NotNull
    public final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$leqS0IyKEB621E1SrHdAcHHAUjScjmKi Method3998() {
        return this.Field12214;
    }

    @NotNull
    @NotNull
    public final wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf Method3999() {
    ...
    public wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz(@NotNull @NotNull String string) {
        Intrinsics.checkParameterIsNotNull((Object)string, (String)"name");
        this.Field12223 = string;
        this.Field12213 = new wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV(this);
        this.Field12214 = new wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$leqS0IyKEB621E1SrHdAcHHAUjScjmKi(this);
        this.Field12215 = new wEMl3HTSYAWS1ZEwLleN64Ds0SjhROrz$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf(this);
        this.Field12216 = ".kis";
    ...
    private static String Method4008(String string) {
        ...
        int n = (int)1657687593L ^ 0x62CE4E29;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)1796302684 ^ (long)1796302755);
            int n2 = (int)1957707830L ^ 0x74B04017;
            cArray2[n] = (char)(cArray[n] ^ (((int)-1727826139L ^ 0x99037192) << 3 ^ n2));
            ++n;
        }
