...
public final class NSewz7oiMYR6VaaGbKeUqvXMcw4Xz6sx {
    @NotNull
    ...
    public NSewz7oiMYR6VaaGbKeUqvXMcw4Xz6sx() {
        this.Field12401.add(new IxCmTWNqonrT1aEfKEwU94YJ2BjoTjI6());
        this.Field12401.add(new ghSZKRHmOFsUArQvfcXaJNGgFBtZnxG0());
    }
}
