...
public final class Class1319 implements Class1776
{
    private String Field14059 = " TheKisDevs & LavaHack Development owns you, and I am sorry, because it is uncrackable <3";
    
    public boolean Method5355(@NotNull @NotNull final BlockPos blockPos) {
        ...
        return Intrinsics.areEqual((Object)getBlockState.getBlock(), (Object)Blocks.WEB);
    }
    
    @Override
    public boolean Method5352(final Object o) {
        return this.Method5355((BlockPos)o);
    }
    
    Class1319() {
    }
    
    private static String Method5356(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x2D7A ^ 0x8));
            }
