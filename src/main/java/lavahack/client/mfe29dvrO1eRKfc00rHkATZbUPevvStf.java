...
public final class mfe29dvrO1eRKfc00rHkATZbUPevvStf {
    @NotNull
    ...
    public final ArrayList Method6999() {
        ...
        while (true) {
            ...
            int n = (int)((long)934983922 ^ (long)934983922);
            int n2 = (int)((long)-33145315 ^ (long)-33145315);
            String string = object;
            int n3 = (int)((long)51263220 ^ (long)51263220);
    ...
    public mfe29dvrO1eRKfc00rHkATZbUPevvStf(@NotNull @NotNull URL uRL) {
        Intrinsics.checkParameterIsNotNull((Object)uRL, (String)"url");
        this.Field16706 = uRL;
    }

    public mfe29dvrO1eRKfc00rHkATZbUPevvStf(@NotNull @NotNull String string) {
    ...
    private static String Method7001(String string) {
        ...
        int n = (int)-765895669L ^ 0xD2595C0B;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)1069967152 ^ (long)1069967311);
            int n2 = (int)((long)-586036467 ^ (long)-586036412);
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)447750451 ^ (long)447774016) ^ n2));
            ++n;
        }
