...
public final class qc9FwVpWiqRQho5VXPrDfJ5nrkFdG0Ld$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf
implements GuiPageButtonList.GuiResponder {
    private int Field12592 = (int)((long)-1408090916 ^ (long)-1408090939) << 2;
    ...
    private static String a(String string) {
        ...
        int n = (int)839129842L ^ 0x32041AF2;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)1062048198 ^ (long)1062048057);
            int n2 = (int)((long)-1162514608 ^ (long)-1162514615) << 3;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-1049338625 ^ (long)-1049352964) ^ n2));
            ++n;
        }
