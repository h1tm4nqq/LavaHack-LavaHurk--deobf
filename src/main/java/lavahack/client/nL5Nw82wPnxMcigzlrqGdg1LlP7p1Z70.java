...
public final class nL5Nw82wPnxMcigzlrqGdg1LlP7p1Z70 {
    @NotNull
    ...
    public nL5Nw82wPnxMcigzlrqGdg1LlP7p1Z70(@NotNull @NotNull Vec2d vec2d, @NotNull @NotNull Vec2d vec2d2) {
    ...
    private static String Method5675(String string) {
        ...
        int n = (int)-232569708L ^ 0xF2234494;
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)1601139948L ^ 0x5F6F7413);
            int n2 = (int)-1626778008L ^ 0x9F095655;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-2006396506 ^ (long)-2006390953) << 1 ^ n2));
            ++n;
        }
