...
final class Class304 implements Class1471
{
    public static final Class304 Field9307;
    ...
    public Object Method1564(final Class424 class424) {
        return this.Method1576(class424);
    }
    
    @Nullable
    @Nullable
    public final Void Method1576(@NotNull @NotNull final Class424 class424) {
        ...
        Class1325.Method5367().player.rotationYawHead = ((float[])class424.Method2054(0))[0];
        Class1325.Method5367().player.renderYawOffset = ((float[])class424.Method2054(0))[0];
        Class1325.Method5367().player.rotationPitch = ((float[])class424.Method2054(0))[1];
        return null;
    }
    
    static {
        Field9307 = new Class304();
    }
    
    private static String Method1577(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x5123 ^ 0x7D));
            }
