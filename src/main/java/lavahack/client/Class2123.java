...
public abstract class Class2123
extends Class441 {
    ...
    private Class2123(Entity entity, double d, double d2, double d3, float f, float f2) {
        super(entity, null);
        this.Field17659 = d;
        this.Field17660 = d2;
        this.Field17661 = d3;
    ...
    public Class2123(Entity entity, double d, double d2, double d3, float f, float f2, DefaultConstructorMarker defaultConstructorMarker) {
        this(entity, d, d2, d3, f, f2);
    }
}
