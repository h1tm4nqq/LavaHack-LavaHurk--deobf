...
final class L40FBRtktxsbtpQN35DnNbJzEkW8lsuS$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV
implements Function {
    ...
    public final Double Method3087(BlockPos blockPos) {
        Double d;
        if (this.Field11166) {
            d = L40FBRtktxsbtpQN35DnNbJzEkW8lsuS.Method5173().player.getDistanceSq(blockPos);
            return d;
        }
    ...
    L40FBRtktxsbtpQN35DnNbJzEkW8lsuS$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV(boolean bl, EntityPlayer entityPlayer) {
        this.Field11166 = bl;
