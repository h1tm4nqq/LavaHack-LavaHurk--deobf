...
implements Class1471 {
    public static final Class335 Field9391 = new Class335();
    ...
    @Nullable
    @Nullable
    public final Void Method1665(@NotNull @NotNull Class424 class424) {
        Intrinsics.checkParameterIsNotNull((Object)class424, (String)"arg");
        Class135.Field8502.Method929().Method1726(class424.Method2054(0), false);
        return null;
    }
    ...
    private static String Method1666(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 254;
            cArray2[n] = (char)(cArray[n] ^ (0x4480 ^ n2));
            ++n;
        }
