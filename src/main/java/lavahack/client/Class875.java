...
implements GenericFutureListener {
    ...
    public final void leqS0IyKEB621E1SrHdAcHHAUjScjmKi(Future future) {
        this.Field11681.Field16972.closeChannel((ITextComponent)this.Field11682);
    }

    Class875(Class1936 class1936, TextComponentString textComponentString) {
        this.Field11681 = class1936;
        this.Field11682 = textComponentString;
    }
}
