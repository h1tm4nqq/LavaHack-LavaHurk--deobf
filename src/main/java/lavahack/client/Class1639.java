...
implements Supplier {
    ...
    public final String Method6372() {
        ...
        Class44 class44 = Class1913.Method7119(this.Field15631);
        Intrinsics.checkExpressionValueIsNotNull((Object)class44, (String)"reverseStepVal");
        return stringBuilder.append(class44.Method335()).append(']').toString();
    }

    Class1639(Class1913 class1913) {
        this.Field15631 = class1913;
    }
    ...
    private static String Method6373(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 185;
            cArray2[n] = (char)(cArray[n] ^ (0x23F9 ^ n2));
            ++n;
        }
