...
implements Class1471 {
    public static final Class834 Field11551 = new Class834();
    ...
    @Nullable
    @Nullable
    public final Void Method3556(@NotNull @NotNull Class424 class424) {
        Intrinsics.checkParameterIsNotNull((Object)class424, (String)"arg");
        Class135.Field8499.Method930().Method1726(class424.Method2054(0), class424.Method2054(1));
        Class135.Field8501.Method930().Method1726(class424.Method2054(0), class424.Method2054(1));
        return null;
    }
    ...
    private static String Method3557(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 151;
            cArray2[n] = (char)(cArray[n] ^ (0x6EED ^ n2));
            ++n;
        }
