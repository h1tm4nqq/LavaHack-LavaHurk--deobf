...
final class Class842 implements Class1471
{
    public static final Class842 Field11571;
    ...
    @Nullable
    @Nullable
    public final Void Method3571(@NotNull @NotNull final Class424 class424) {
        Intrinsics.checkParameterIsNotNull((Object)class424, "arg");
        Class135.Field8500.Method929().Method1726(new Object[] { class424.Method2054(0), class424.Method2054(1) });
        Class135.Field8501.Method929().Method1726(new Object[] { class424.Method2054(0), class424.Method2054(1) });
        return null;
    }
    
    static {
        Field11571 = new Class842();
    }
    
    private static String Method3572(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x185D ^ 0xA5));
            }
