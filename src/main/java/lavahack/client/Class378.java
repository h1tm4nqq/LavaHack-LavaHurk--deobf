...
public final class Class378 {
    ...
    public final byte[] Method1840() {
        String string = "IFILE:" + this.Field9589 + ':' + this.Field9591 + ":IFILE";
    ...
    public Class378(@NotNull @NotNull String string, @NotNull @NotNull byte[] byArray, @NotNull @NotNull String string2) {
    ...
    public Class378(@NotNull @NotNull File file, @NotNull @NotNull String string) {
    ...
    public Class378(File file, String string, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 2) != 0) {
            string = "";
        }
        this(file, string);
    ...
    private static String Method1844(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 121;
            cArray2[n] = (char)(cArray[n] ^ (0x79EA ^ n2));
            ++n;
        }
