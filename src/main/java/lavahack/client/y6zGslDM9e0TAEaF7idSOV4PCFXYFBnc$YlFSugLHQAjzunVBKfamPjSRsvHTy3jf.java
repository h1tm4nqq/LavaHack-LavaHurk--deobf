...
final class y6zGslDM9e0TAEaF7idSOV4PCFXYFBnc$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf
extends hbD4kseV1VTER7aHOSIdAw4x7SiMKhfb {
    ...
    public y6zGslDM9e0TAEaF7idSOV4PCFXYFBnc$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf(@NotNull @NotNull FrvoqED59Mj96pmO7hxn2tEew1fZAOzj frvoqED59Mj96pmO7hxn2tEew1fZAOzj) {
        Intrinsics.checkParameterIsNotNull((Object)frvoqED59Mj96pmO7hxn2tEew1fZAOzj, (String)"instance");
        super("test3", frvoqED59Mj96pmO7hxn2tEew1fZAOzj);
    }
    ...
    private static String Method441(String string) {
        ...
        int n = (int)((long)-1611694062 ^ (long)-1611694062);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)-1636200290L ^ 0x9E799061);
            int n2 = (int)-1780620553L ^ 0x95DDE2EA;
            cArray2[n] = (char)(cArray[n] ^ ((int)1882738706L ^ 0x7038307D ^ n2));
            ++n;
        }
