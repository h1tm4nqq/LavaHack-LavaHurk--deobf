...
public interface jJcUSRXu0Im8nLcKYmuhBmfEwpYAcE2m {
    ...
    public static JsonElement Method6477(String string) {
        return jJcUSRXu0Im8nLcKYmuhBmfEwpYAcE2m.Method6478(string, (boolean)((long)58381448 ^ (long)58381449));
    }
    ...
    public static JsonElement Method6478(String string, boolean bl) {
        ...
        Object var4_4 = null;
        jsonReader.setLenient((boolean)((long)13336304 ^ (long)13336305));
