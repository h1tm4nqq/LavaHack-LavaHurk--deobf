...
final class O1wfrBba1z1C4gxnTtwfHkAxEr02HOc6$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV
implements hb5tz3bI7hH2ondwVV1qsjfgyxSY9bQt {
    public static final O1wfrBba1z1C4gxnTtwfHkAxEr02HOc6$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV Field14135 = new O1wfrBba1z1C4gxnTtwfHkAxEr02HOc6$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV();
    private String Field14136 = " TheKisDevs & LavaHack Development owns you, and I am sorry, because it is uncrackable <3";

    @Override
    public void Method979(Object object) {
        this.Method5413((TAt7QzOqrfY8P9hNnkrnImm9scdhYm72$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV)object);
    }

    public final void Method5413(TAt7QzOqrfY8P9hNnkrnImm9scdhYm72$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV tAt7QzOqrfY8P9hNnkrnImm9scdhYm72$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV) {
    ...
    O1wfrBba1z1C4gxnTtwfHkAxEr02HOc6$vl3icpcdb9cWvH39NKe3weWQwVdWO7AV() {
    }
    ...
    private static String Method5414(String string) {
        ...
        int n = (int)((long)-1773639497 ^ (long)-1773639497);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)2124130758 ^ (long)2124130617);
            int n2 = (int)((long)2005291125 ^ (long)2005291060);
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-553306325 ^ (long)-553306150) << 3 ^ n2));
            ++n;
        }
