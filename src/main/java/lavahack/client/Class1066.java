...
public final class Class1066 implements Class817
{
    ...
    public boolean Method3473(@NotNull @NotNull final BlockPos blockPos) {
        ...
        return this.Field12699.Method3790() && this.Field12700.Method2906().Method6698(blockPos);
    }
    ...
    public Class1066(@NotNull @NotNull final Class693 field12700, @NotNull @NotNull final Class42 field12701) {
        Intrinsics.checkParameterIsNotNull((Object)field12700, "block");
        Intrinsics.checkParameterIsNotNull((Object)field12701, "module");
        this.Field12700 = field12700;
        this.Field12701 = field12701;
        this.Field12698 = this.Field12701.Method24(new Class1996(new Class44(this.Field12700.name(), this.Field12701)));
        final Class1612 class1612 = (Class1612)new Class1612(this.Field12701).Method773(this.Field12700.name());
        final Class1996 field12702 = this.Field12698;
        Intrinsics.checkExpressionValueIsNotNull((Object)field12702, "group");
        this.Field12699 = ((Class1612)class1612.Method772(field12702)).Method3788().Method3789();
    }
    
    private static String Method4327(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x4551 ^ 0x28));
            }
