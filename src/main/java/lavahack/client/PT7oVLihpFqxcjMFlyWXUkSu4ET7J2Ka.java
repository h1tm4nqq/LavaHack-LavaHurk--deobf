...
public final class PT7oVLihpFqxcjMFlyWXUkSu4ET7J2Ka
extends nsTNVxglJUlYpMYh0ZtA62wP57yhdiso
implements NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ {
    private final TmOPym6tdKb9sCSEqlHetKWFnNqangKd Field15121;
    ...
    public PT7oVLihpFqxcjMFlyWXUkSu4ET7J2Ka(@NotNull @NotNull NetworkManager networkManager) {
        Intrinsics.checkParameterIsNotNull((Object)networkManager, (String)"manager");
        super(networkManager, 0x290587A2L & 0x46439EA0L);
        this.Field15121 = new TmOPym6tdKb9sCSEqlHetKWFnNqangKd();
    }

    @Override
    public void handle(@NotNull @NotNull Packet packet) {
        Intrinsics.checkParameterIsNotNull((Object)packet, (String)"packet");
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2691(this, packet);
    }
    ...
    public void processCloseWindow(@NotNull @NotNull CPacketCloseWindow cPacketCloseWindow) {
        ...
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2702(this, cPacketCloseWindow);
    }
    ...
    public void processPlayer(@NotNull @NotNull CPacketPlayer cPacketPlayer) {
        ...
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2706(this, cPacketPlayer);
    }
    ...
    public void processEntityAction(@NotNull @NotNull CPacketEntityAction cPacketEntityAction) {
        ...
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2709(this, cPacketEntityAction);
    }
    ...
    public void processInput(@NotNull @NotNull CPacketInput cPacketInput) {
        ...
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2710(this, cPacketInput);
    }
    ...
    public void processHeldItemChange(@NotNull @NotNull CPacketHeldItemChange cPacketHeldItemChange) {
        ...
        NOpZBw6i2rktXmqv4a9ebTMCtK7GxXhQ$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf.Method2711(this, cPacketHeldItemChange);
    }
    ...
    private static String a(String string) {
        ...
        int n = (int)((long)1557512998 ^ (long)1557512998);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)515337071 ^ (long)515337104);
            int n2 = (int)((long)-404884350 ^ (long)-404884387);
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)1720906399 ^ (long)1720907366) << 4 ^ n2));
            ++n;
        }
