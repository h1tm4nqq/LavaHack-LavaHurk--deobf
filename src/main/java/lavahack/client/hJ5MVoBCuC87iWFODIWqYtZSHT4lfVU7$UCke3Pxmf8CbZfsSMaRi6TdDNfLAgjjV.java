...
public final class hJ5MVoBCuC87iWFODIWqYtZSHT4lfVU7$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV {
    @NotNull
    private final IBONRcQCNUBg2NBpVpVQf61ykmVfU03E Field11271;
    @NotNull
    ...
    @NotNull
    @NotNull
    public final IBONRcQCNUBg2NBpVpVQf61ykmVfU03E Method3220() {
        return this.Field11271;
    }

    public final boolean Method3221() {
        return this.Field11271.Method2797(0x412187D0L & 0x125267D1L);
    }
    ...
    public hJ5MVoBCuC87iWFODIWqYtZSHT4lfVU7$UCke3Pxmf8CbZfsSMaRi6TdDNfLAgjjV(@NotNull @NotNull Vec3d vec3d, long l) {
        Intrinsics.checkParameterIsNotNull((Object)vec3d, (String)"pos");
        this.Field11272 = vec3d;
        this.Field11273 = l;
        this.Field11271 = new IBONRcQCNUBg2NBpVpVQf61ykmVfU03E();
    }
    ...
    private static String Method3226(String string) {
        ...
        int n = (int)((long)213935002 ^ (long)213935002);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)831896647 ^ (long)831896760);
            int n2 = (int)((long)2061553147 ^ (long)2061553138) << 2;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-997828532 ^ (long)-997826975) << 4 ^ n2));
            ++n;
        }
