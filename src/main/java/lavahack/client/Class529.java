...
public final class Class529
{
    ...
    public final void Method2402(@NotNull @NotNull final GuiTextField field10234) {
        Intrinsics.checkParameterIsNotNull((Object)field10234, "<set-?>");
        this.Field10234 = field10234;
    }
    ...
    public final void Method2404(@NotNull @NotNull final ArrayList field10235) {
        Intrinsics.checkParameterIsNotNull((Object)field10235, "<set-?>");
    ...
    public final void Method2407(final int x, final int n, final int width, final int n2) {
        this.Field10234.x = x;
        this.Field10234.y = n - this.Field10236 - this.Field10237;
        this.Field10234.width = width;
        this.Field10234.height = this.Field10237;
    }
    
    public Class529() {
        this.Field10234 = new GuiTextField(9999, Minecraft.getMinecraft().fontRenderer, 0, 0, 0, 0);
        this.Field10235 = new ArrayList();
    }
    
    private static String Method2408(final String s) {
        if (s != null) {
            final char[] charArray = s.toCharArray();
            final char[] value = new char[charArray.length];
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x1C33 ^ 0xF3));
            }
