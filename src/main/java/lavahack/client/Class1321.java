...
implements Class1776 {
    ...
    public boolean Method5357(@NotNull @NotNull BlockPos blockPos) {
        ...
        List list = Class2142.Field17803.world.getEntitiesWithinAABB(EntityPlayer.class, Class2142.Field17803.world.getBlockState(blockPos).getSelectedBoundingBox((World)Class2142.Field17803.world, blockPos));
    ...
    private static String Method5358(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 10;
            cArray2[n] = (char)(cArray[n] ^ (0x353 ^ n2));
            ++n;
        }
