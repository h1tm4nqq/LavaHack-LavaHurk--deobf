...
implements Class1471 {
    public static final Class832 Field11547 = new Class832();
    ...
    @Nullable
    @Nullable
    public final Void Method3554(@NotNull @NotNull Class424 class424) {
        Intrinsics.checkParameterIsNotNull((Object)class424, (String)"arg");
        Class135.Field8499.Method929().Method1726(class424.Method2054(0), class424.Method2054(1));
    ...
    private static String Method3555(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 19;
            cArray2[n] = (char)(cArray[n] ^ (0x82E ^ n2));
            ++n;
        }
