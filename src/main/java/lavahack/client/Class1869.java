...
class Class1869 extends Class1740
{
    ...
    private TextComponentTranslation Method6965(final Class42 class42) {
    ...
    public void Method1881(final ITextComponent textComponent) {
        this.Method1874(new TextComponentTranslation(Method6963(), new Object[0]).appendSibling(textComponent));
    }
    ...
    public void Method1884(final ITextComponent textComponent, final Class42 class42) {
        this.Method1874(new TextComponentTranslation(Method6963(), new Object[0]).appendSibling((ITextComponent)this.Method6965(class42)).appendSibling(textComponent));
    }
    
    public void Method1885(final ITextComponent textComponent) {
        this.Method1874(new TextComponentTranslation(Method6963(), new Object[0]).appendSibling((ITextComponent)this.Method6964()).appendSibling(textComponent));
    }
    ...
    public void Method1887(final ITextComponent textComponent) {
        this.Method1874(this.Method6964().appendSibling(textComponent));
    }
    ...
    public void Method1889(final ITextComponent textComponent) {
        this.Method1874(this.Method6966().appendSibling(textComponent));
    }
    ...
    public void Method1891(final ITextComponent textComponent) {
        this.Method1874(new TextComponentTranslation(Method6963(), new Object[0]).appendSibling((ITextComponent)this.Method6966()).appendSibling(textComponent));
    }
    ...
    private static String Method1893(final String s) {
        if (s != null) {
            ...
            for (int i = 0; i < charArray.length; ++i) {
                value[i] = (char)(charArray[i] ^ (0x2A22 ^ 0x0));
            }
