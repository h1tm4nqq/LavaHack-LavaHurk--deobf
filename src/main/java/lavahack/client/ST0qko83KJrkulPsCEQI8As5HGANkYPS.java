...
public final class ST0qko83KJrkulPsCEQI8As5HGANkYPS {
    ...
    private static String Method6498(String string) {
        ...
        int n = (int)((long)505872648 ^ (long)505872648);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & ((int)547355258L ^ 0x209FFA85);
            int n2 = (int)((long)-9657075 ^ (long)-9657048);
            cArray2[n] = (char)(cArray[n] ^ (((int)662041008L ^ 0x2775F16B) << 6 ^ n2));
            ++n;
        }
