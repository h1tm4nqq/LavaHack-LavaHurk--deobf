...
import lavahack.client.Class1836;
...
final class Class1032 {
    ...
    public Class1032(@NotNull @NotNull EntityPlayer entityPlayer) {
        ...
        this.Field12528 = new EntityOtherPlayerMP((World)Class1836.Method6929().world, gameProfile);
    ...
    private static String Method4184(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 1;
            cArray2[n] = (char)(cArray[n] ^ (0x265F ^ n2));
            ++n;
        }
