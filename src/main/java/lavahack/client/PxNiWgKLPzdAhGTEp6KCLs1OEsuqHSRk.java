...
import lavahack.client.PxNiWgKLPzdAhGTEp6KCLs1OEsuqHSRk$leqS0IyKEB621E1SrHdAcHHAUjScjmKi;
...
public final class PxNiWgKLPzdAhGTEp6KCLs1OEsuqHSRk {
    @NotNull
    private final IBONRcQCNUBg2NBpVpVQf61ykmVfU03E Field12185 = new IBONRcQCNUBg2NBpVpVQf61ykmVfU03E();
    private int Field12186;
    private int Field12187;
    @F3RUJ4pqKqExz7WB5oipQI42Y4NfLlLa
    @NotNull
    private final CWbHmUEXMBlBn6yy1FNsdHDsxUN4RrYt Field12188 = new CWbHmUEXMBlBn6yy1FNsdHDsxUN4RrYt((hb5tz3bI7hH2ondwVV1qsjfgyxSY9bQt)new PxNiWgKLPzdAhGTEp6KCLs1OEsuqHSRk$leqS0IyKEB621E1SrHdAcHHAUjScjmKi(this), new Predicate[(int)151187646L ^ 0x902F0BE]);
    private String Field12189 = " TheKisDevs & LavaHack Development owns you, and I am sorry, because it is uncrackable <3";

    @NotNull
    @NotNull
    public final IBONRcQCNUBg2NBpVpVQf61ykmVfU03E Method3984() {
    ...
    @NotNull
    @NotNull
    public final CWbHmUEXMBlBn6yy1FNsdHDsxUN4RrYt Method3989() {
        return this.Field12188;
    }

    public final int Method3990() {
        if (!this.Field12185.Method2797(0x9A0BFBL & 0xC0023E8L)) return this.Field12187;
        if (this.Field12186 == 0) {
            this.Field12187 = (int)-1149233420L ^ 0xBB8016F4;
            this.Field12185.Method2801();
            return this.Field12187;
        }
        this.Field12187 = this.Field12186;
        this.Field12185.Method2801();
        this.Field12186 = (int)((long)541865384 ^ (long)541865384);
        return this.Field12187;
    }

    public PxNiWgKLPzdAhGTEp6KCLs1OEsuqHSRk() {
        leqS0IyKEB621E1SrHdAcHHAUjScjmKi.Field16242.Method706(this.Field12188);
    }
}
