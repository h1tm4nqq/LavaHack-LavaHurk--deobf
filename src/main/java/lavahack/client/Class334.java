...
import lavahack.client.Class342;
...
implements Supplier {
    ...
    public final boolean Method1663() {
        Class44 class44 = Class342.Method1684(this.Field9389);
        Intrinsics.checkExpressionValueIsNotNull((Object)class44, (String)"fade");
        return class44.Method365();
    }

    Class334(Class342 class342) {
        this.Field9389 = class342;
    }
    ...
    private static String Method1664(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 144;
            cArray2[n] = (char)(cArray[n] ^ (0x74E3 ^ n2));
            ++n;
        }
