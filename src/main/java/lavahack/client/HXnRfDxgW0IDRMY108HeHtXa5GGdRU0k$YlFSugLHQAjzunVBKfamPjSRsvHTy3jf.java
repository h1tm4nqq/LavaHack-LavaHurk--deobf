...
public final class HXnRfDxgW0IDRMY108HeHtXa5GGdRU0k$YlFSugLHQAjzunVBKfamPjSRsvHTy3jf {
    ...
    private static String Method6214(String string) {
        ...
        int n = (int)((long)1728413498 ^ (long)1728413498);
        while (n < cArray.length) {
            int cfr_ignored_0 = n & (int)((long)-1832874063 ^ (long)-1832874162);
            int n2 = ((int)-1414028337L ^ 0xABB7A3EE) << 1;
            cArray2[n] = (char)(cArray[n] ^ ((int)((long)-2094327174 ^ (long)-2094324819) ^ n2));
            ++n;
        }
