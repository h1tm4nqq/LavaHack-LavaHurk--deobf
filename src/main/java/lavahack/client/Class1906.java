...
public final class Class1906
extends Class2123 {
    private int Field16771;

    public Class1906(@NotNull @NotNull Entity entity, double d, double d2, double d3, float f, float f2) {
    ...
    private static String Method170(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 125;
            cArray2[n] = (char)(cArray[n] ^ (0x2AB8 ^ n2));
            ++n;
        }
