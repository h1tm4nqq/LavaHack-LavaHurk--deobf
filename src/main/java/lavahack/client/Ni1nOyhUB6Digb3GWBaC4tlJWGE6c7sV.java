...
public class Ni1nOyhUB6Digb3GWBaC4tlJWGE6c7sV {
    ...
    public static List Method6135(Entity entity, double d) {
        List list = Ni1nOyhUB6Digb3GWBaC4tlJWGE6c7sV.Method6136(entity, d);
        ArrayList arrayList = new ArrayList();
        list.forEach(arg_0 -> Ni1nOyhUB6Digb3GWBaC4tlJWGE6c7sV.Method6137(arrayList, arg_0));
