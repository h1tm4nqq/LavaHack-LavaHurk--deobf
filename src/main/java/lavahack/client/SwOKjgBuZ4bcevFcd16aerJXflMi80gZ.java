...
public class SwOKjgBuZ4bcevFcd16aerJXflMi80gZ {
    ...
    public SwOKjgBuZ4bcevFcd16aerJXflMi80gZ(long l, double d, double d2) {
        this.Field9489 = l;
        this.Field9490 = d;
        this.Field9491 = d2;
        this.Field9496 = System.currentTimeMillis();
        this.Field9493 = (int)439303019L ^ 0x1A2F3B6A;
    ...
    public void Method1794() {
        this.Field9493 = (int)((long)1852256213 ^ (long)1852256212);
    }

    public void Method1795() {
        this.Field9493 = (int)-1435188298L ^ 0xAA74C3B6;
    }
