...
class Class675 extends AbstractIterator
{
    ...
    Class675(final Class457 field10870) {
        this.Field10870 = field10870;
    ...
    protected Class16 Method2859() {
        if (this.Field10866 == null) {
            ...
            return this.Field10866 = new Class16(this.Field10867, this.Field10868, this.Field10869);
        }
        if (this.Field10866.equals((Object)this.Field10870.Field9901)) {
