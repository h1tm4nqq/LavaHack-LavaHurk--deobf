...
public final class Class1441 {
    ...
    public final byte[] Method5750() {
        String string = "IFILE:" + this.Field14751 + ':' + this.Field14753 + ":IFILE";
    ...
    public Class1441(@NotNull @NotNull String string, @NotNull @NotNull byte[] byArray, @NotNull @NotNull String string2) {
    ...
    public Class1441(@NotNull @NotNull File file, @NotNull @NotNull String string) {
    ...
    public Class1441(File file, String string, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 2) != 0) {
            string = "";
        }
        this(file, string);
    ...
    private static String Method5754(String string) {
        ...
        while (n < cArray.length) {
            ...
            int n2 = 110;
            cArray2[n] = (char)(cArray[n] ^ (0x28F2 ^ n2));
            ++n;
        }
